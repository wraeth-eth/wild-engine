...
const MODEL_VERTEX_ATTRIBUTES: [wgpu::VertexAttribute; 5] = wgpu::vertex_attr_array![
    0 => Float32x3,
    1 => Float32x2,
    2 => Float32x3,
    3 => Float32x3,
    ...
    'b: 'a,
{
    fn draw_light_mesh(
        ...
        self.draw_light_mesh_instanced(mesh, material, camera_bind_group, light_bind_group, 0..1);
    }
